    ...
    static Dictionary<ConfessionTechId, ConfessionTechNode> Build()
    {
        ...
        var list = new[]
        {
            ...
            new ConfessionTechNode(
                ...
                "Wharf, fishing post, coastal patrol & explorer at coastal cities; +1 settlement manuscript",
            ...
            new ConfessionTechNode(
                ...
                "War dock, galley; coastal patrol & galley +1 move; naval units +1 defense",
                orthodoxy, tier: 3, manuscriptCost: 3, turnsToComplete: 3, minAdherence: 55f,
                track: TechTrack.Secular,
                figureName: "Martin Chemnitz", lifespan: "1524-1586",
            ...
            new ConfessionTechNode(
                ...
                "All units +1 movement; soldiers +1 attack; unlocks siege engines",
