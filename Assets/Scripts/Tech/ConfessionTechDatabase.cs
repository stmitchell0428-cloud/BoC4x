    ...
    static Dictionary<ConfessionTechId, ConfessionTechNode> Build()
    {
        ...
        var list = new[]
        {
            ...
            new ConfessionTechNode(
                ...
                "Wharf, fishing post, coastal explorer at coastal cities; +1 settlement manuscript",
            ...
            new ConfessionTechNode(
                ...
                "War dock, galley; coastal naval +1 move; naval units +1 defense",
                orthodoxy, tier: 3, manuscriptCost: 3, turnsToComplete: 3, minAdherence: 55f,
                track: TechTrack.Secular,
                figureName: "Martin Chemnitz", lifespan: "1524-1586",
            ...
            new ConfessionTechNode(
                ...
                "+8 preach comfort (emphasis path adds Law/Gospel drift halving)",
            ...
            new ConfessionTechNode(
                ...
                "+8 preach comfort; decay -10% (emphasis path adds drift halving / preach bonus)",
            ...
            new ConfessionTechNode(
                ...
                "Soldiers +2 defense; siege engines +2 pressure",
            ...
            new ConfessionTechNode(
                ...
                "All units +1 movement; soldiers +1 attack; +1 siege pressure; unlocks siege engine training (Chytraeus + local armory at Garrison)",
