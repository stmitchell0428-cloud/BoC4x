...
- **Late naval (Tier 3–4 secular):** **Naval Warfare & War Docks** at a **coastal Garrison** district → War Dock + Galley; **Open-Ocean Navigation** → Deep-Sea Ship. **Frontier Mission** is missionaries/settlers only — no Bach fork lock.
